...
with open(".\FNNresults" +"_nhid{}_emsize{}_tied{}.csv".format(args.nhid,args.emsize,args.tied),"w", newline = '') as csv_file:
    ...
    try:
        for epoch in range(1, args.epochs+1):
            ...
            if not best_val_loss or val_loss < best_val_loss:
                with open(args.save + "_nhid{}_emsize{}.pt".format(args.nhid,args.emsize), 'wb') as f:
                    torch.save(model, f)
                ...
                lr /= 4.0
                if (args.optimizer!='ADAM'):
                    print('learning rate changed to: ' + "{}".format(lr))
    except KeyboardInterrupt:
        print('-' * 89)
        print('Exiting from training early')

# Load the best saved model.
with open(args.save + "_nhid{}_emsize{}_tied{}.pt".format(args.nhid,args.emsize,args.tied), 'rb') as f:
    model = torch.load(f)
